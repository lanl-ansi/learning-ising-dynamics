...
if FLAG_lattice_gm
    ...
    file_adj_matrix_gm = "adj_matrix_ferro_lattice_gm_A_M_reg_sensitivity.txt"
    # name of picture to save graphical model in
    file_plot_gm = "ferro_lattice_gm_A_M.eps"
    # File to save final results
    file_M_opt_gm = "M_opt_RR_FigA_M_RISE_reg_sensitivity_beta_1_5.txt"
...
c_array = vcat([0.02,0.04],[0.05 + 0.05*i for i=0:9],[0.5 + 0.1*i for i=1:15])
