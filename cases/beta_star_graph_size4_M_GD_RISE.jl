...
file_M_opt_gm = "M_opt_stargraph_s4_M_RISE.txt"
...
let
    ...
    for i = 1:length(β_array)
        ...
        M_opt[i] = get_M_opt_glauber_dynamics(adj_matrix, RISE(0.0, true), learning_algo, sampling_regime, τ, L, M_guess, M_factor)
