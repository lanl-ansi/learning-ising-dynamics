...
if FLAG_lattice_gm
    ...
    file_M_opt_gm = "M_opt_Ferro_Lattice_C_M_RISE_corrected_regularization2.txt"
...
let
    ...
    for i = 1:length(β_array)
        ...
        M_opt[i] = get_M_opt_glauber_dynamics_regularization(adj_matrix, RISE(0.5, true), learning_algo, sampling_regime, τ, L, M_guess, M_factor)
