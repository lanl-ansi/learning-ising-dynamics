...
if FLAG_lattice_gm
    ...
    file_adj_matrix_gm = "adj_matrix_ferro_lattice_gm_E_T_RPLE.txt"
    # name of picture to save graphical model in
    file_plot_gm = "ferro_lattice_gm_E_T22.eps"
    # File to save final results
    file_M_opt_gm = "M_opt_Ferro_Lattice_E_T_RPLE.txt"
